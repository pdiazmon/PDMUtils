...
public extension String {
	...
	public func pdmIsHexadecimal() -> Bool {
		for c in self {
	...
	public func pdmSubstring(fromIndex: Int, numberOfCharacters: Int) -> String? {
